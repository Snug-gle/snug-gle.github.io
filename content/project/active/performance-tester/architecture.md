...
# Performance Tester - 프로젝트 아키텍처

> **Performance Tester Correlation Analysis Tool** 전체 아키텍처 및 코드베이스 분석 문서

## 관련 문서
- [[Performance Tester 프로젝트 면접 준비]] - 프론트엔드 중심 면접 준비 자료
...
**Performance Tester - Correlation Analysis Tool**은 웹 애플리케이션의 성능 테스트 자동화를 지원하는 도구입니다.
...
### 내부 문서
- [[Performance Tester 프로젝트 면접 준비]] - 프론트엔드 중심 면접 준비
