...
- **archieve/**: Completed or inactive items
...
- IDE-specific files (IntelliJ, VS Code)
- Build artifacts (Java, Gradle, Kotlin)
- System files (macOS, Windows)
- `.trash/` directory

Note that some directories like `/project/inbox/`, `/area/private/`, and `/area/work/` are listed in gitignore but currently tracked (commented out in .gitignore:268-270).
